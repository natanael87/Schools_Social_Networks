# -*- coding: utf-8 -*-
"""
Created on Wed May 28 21:40:34 2014
...
###}
m=4
xi=linspace(0,60,m+1)
yi=pro(xi.all())
#z1_q=sinteg.quad(pro,0,60)
#print 'quad', z1_q

m=4
xi=linspace(0,1,m+1)
yi=f(xi.all())
#print 'quad', sinteg.quad(f,0,1)

m=4
xi=linspace(1,80,m+1)
yi=f(xi.all())
#print 'quad', sinteg.quad(f,1,80)
