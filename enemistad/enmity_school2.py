# -*- coding: utf-8 -*-
"""
Created on Thu Jun  5 20:38:28 2014
...
s_pro=178.0/nx.number_connected_components(G)
...
plt.text(0.0018,s_pro+3,r"$3.96$", fontsize=14, color="black")
plt.text(0.0018,(z1/z2)*n+5,r"$68.34$", fontsize=14, color="black")
plt.text(0.37, 220,'b', fontsize=14, color="black")
plt.axis([0,0.4, -50, n+50])
plt.tick_params(axis='both', which='major', labelsize=12)
#plt.title('Percolation Threshold', fontsize=20)
#plt.xlabel("Connected vertices $b$", fontsize=12)
plt.ylabel(r"$Tama\~no \ promedio \ de \ componente \ s$", fontsize=16)
plt.plot(b,s, P, y, 'go')