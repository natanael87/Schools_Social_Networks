# -*- coding: utf-8 -*-
"""
Created on Mon May 26 09:11:30 2014
...
e=zeros((n+3,1))
for i in xrange(n+3):
    e[i]=exp(-z)*(-1)**(i+1)*facto(i)/(log(z)-alp)**(i+1)
print e

#producto punto con la columna de coeficientes
coef=matrix(dos[0:n+3]).transpose()/facto(n)
print
print dot(coef,e)
