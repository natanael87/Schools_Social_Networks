# -*- coding: utf-8 -*-
"""
Created on Mon Jul 14 18:48:57 2014
...
E=nx.read_adjlist('ene3CG.txt',nodetype=int)
...
plt.text(0.0018,n+5,r"$309$", fontsize=14, color="black")
plt.text(0.0018,(z1/z2)*n+4,r"$74.47$", fontsize=14, color="black")
plt.text(0.38,330,'c', fontsize=14, color="black")
plt.axis([0,0.4, -50, n+70])
plt.tick_params(axis='both', which='major', labelsize=10)
plt.xlabel(r"$Fracci\'on \ de \ nodos \ activos$", fontsize=16)
plt.plot(b,s, P,y, 'go')