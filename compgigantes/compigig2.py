# -*- coding: utf-8 -*-
"""
Created on Mon Jul 14 18:33:08 2014
...
E=nx.read_adjlist('ene2CG.txt',nodetype=int)
...
plt.text(0.0018,n+5,r"$172$", fontsize=14, color="black")
plt.text(0.0018,(z1/z2)*n+4,r"$52.21$", fontsize=14, color="black")
plt.text(0.38,170,'b', fontsize=14, color="black")
plt.axis([0,0.4, -50, n+50])
plt.tick_params(axis='both', which='major', labelsize=10)
plt.ylabel("$Tama\~no \ promedio \ de \ componente$", fontsize=16)
plt.plot(b,s, P,y, 'go')